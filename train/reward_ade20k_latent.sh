...
# CONTROLNET_DIR="work_dirs/reward_model/Captioned_ADE20K/uncertainty-latent-a5-r0.1_Jul28_02-55-04/checkpoint-5700/controlnet"
export REWARDMODEL_DIR="mmseg::upernet/upernet_r50_4xb4-160k_ade20k-512x512.py"
export OUTPUT_DIR="work_dirs/reward_model/Captioned_ADE20K/uncertainty-latent"
...
accelerate launch --config_file "train/config2.yml" \
 --main_process_port=23158 train/reward_control_latent.py \
 ...
 --grad_scale=0.5 \
 --exp_name="uncertainty-latent-a1-r0.1" \
 --uncertainty \
 --add_timestep=1 \
 --uncertainty_scale=0.1

#a1r0.1
CUDA_VISIBLE_DEVICES=4,5 bash train/reward_ade20k_latent.sh --grad_scale 0.5 --checkpointing_steps 2000 --add_timestep 1 --uncertainty_scale 0.1 --exp_name uncertainty-latent-a1-r0.1
#a5r0.1
CUDA_VISIBLE_DEVICES=0,1 bash train/reward_ade20k_latent.sh --grad_scale 0.5 --checkpointing_steps 2000 --add_timestep 5 --uncertainty_scale 0.1 --exp_name uncertainty-latent-a5-r0.1
