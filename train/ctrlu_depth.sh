...
export CONTROLNET_DIR="checkpoint/finetune/depth"
export REWARDMODEL_DIR="Intel/dpt-hybrid-midas"
export OUTPUT_DIR="work_dirs/reward_model/depth/ctrl-u"

accelerate launch --config_file "train/config.yml" \
 --main_process_port=$(python3 random_port.py) train/ctrlu-depth.py \
