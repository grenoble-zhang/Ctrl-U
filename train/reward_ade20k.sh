...
# export CONTROLNET_DIR="work_dirs/reward_model/Captioned_ADE20K/uncertainty-output-a5r0.1_Jul28_00-14-20/checkpoint-6300/controlnet"
export REWARDMODEL_DIR="mmseg::upernet/upernet_r50_4xb4-160k_ade20k-512x512.py"
export OUTPUT_DIR="work_dirs/reward_model/Captioned_ADE20K/uncertainty-output"
...
accelerate launch --config_file "train/config2.yml" \
 --main_process_port=23161 train/reward_control.py \
 ...
 --grad_scale=0.5 \
 --exp_name="uncertainty-output-a1-r0.1" \
 --uncertainty \
 --add_timestep=1 \
 --uncertainty_scale=0.1
# CUDA_VISIBLE_DEVICES=0,1,2,3 bash train/reward_ade20k.sh --grad_scale 0.5 --checkpointing_steps=2000 --exp_name="uncertainty-1"
# CUDA_VISIBLE_DEVICES=0,1,2,3 bash train/reward_ade20k.sh --grad_scale 0.5 --checkpointing_steps=300 --exp_name="uncertainty-2"


# #a1r0.1
# CUDA_VISIBLE_DEVICES=0,1 bash train/reward_ade20k.sh --grad_scale 0.5 --checkpointing_steps 2000 --add_timestep 1 --uncertainty_scale 0.1 --exp_name uncertainty-output-a1-r0.1
# #a5r0.1
# CUDA_VISIBLE_DEVICES=2,3 bash train/reward_ade20k.sh --grad_scale 0.5 --checkpointing_steps 2000 --add_timestep 5 --uncertainty_scale 0.1 --exp_name uncertainty-output-a5-r0.1


# CUDA_VISIBLE_DEVICES=2,3 bash train/reward_ade20k.sh --grad_scale 0.5 --checkpointing_steps 1500 --add_timestep 5 --uncertainty_scale 0.1 --exp_name uncertainty-output-a5-r0.1
