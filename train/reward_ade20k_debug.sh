...
export OUTPUT_DIR="work_dirs/reward_model/Captioned_ADE20K/debug"
...
accelerate launch --config_file "train/debug.yml" \
 --main_process_port=23162 train/reward_control_debug.py \
 ...
 --grad_scale=0.5 \
 --exp_name="uncertainty-debug" \
 --uncertainty \
 --add_timestep=1 \
 --uncertainty_scale=0.1

#debug
# CUDA_VISIBLE_DEVICES=7 bash train/reward_ade20k_debug.sh
